...
def main():
    ...
    parser.add_argument("--input-folder", default="datasets/coco/val2014", type=str)
    parser.add_argument("--output", default="outputs/val_nein_samples", type=str)
    ...
    with torch.no_grad(), autocast("cuda"), model.ema_scope():
        for entry in captions_data:
            ...
            generated_captions = entry['generated_caption']
            image_path = f"{args.input_folder}/{image_name}"
            ...
            for idx, generated_caption in enumerate(generated_captions, 1):
                cond = {}
                cond["c_crossattn"] = [model.get_learned_conditioning([generated_caption])]
